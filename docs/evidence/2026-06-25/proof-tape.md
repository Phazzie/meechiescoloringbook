...
Generated at: 2026-06-25T16:09:24.577Z
Evidence folder: docs/evidence/2026-06-25

Files included:
- assumption-alarm.json (3636 bytes)
- chamber-lock.json (24795 bytes)
- cipher-gate.json (1813 bytes)
- clan-chain.json (2247 bytes)
- clan-chain.md (1418 bytes)
- pdf-lib-lazy-load-build-after.txt (8521 bytes)
  Commands: meechies-coloringbook@0.1.0 build | vite build | Using @sveltejs/adapter-vercel
- pdf-lib-lazy-load-bundle-diff.txt (2633 bytes)
- pdf-lib-lazy-load-check.txt (240 bytes)
  Commands: meechies-coloringbook@0.1.0 check | svelte-kit sync && svelte-check --tsconfig ./tsconfig.json
- pdf-lib-lazy-load-diff-check.txt (0 bytes)
- pdf-lib-lazy-load-diff.txt (929 bytes)
- pdf-lib-lazy-load-focused-tests.txt (662 bytes)
- pdf-lib-lazy-load-lint.txt (48 bytes)
  Commands: meechies-coloringbook@0.1.0 lint | eslint .
- proof-tape.json (5177 bytes)
- proof-tape.md (1876 bytes)
