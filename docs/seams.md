...
| PromptCompilerSeam | src/lib/seams/prompt-compiler-seam/contract.ts | src/lib/seams/prompt-compiler-seam/probe.ts | N/A (fixture module: src/lib/seams/prompt-compiler-seam/fixtures.ts) | src/lib/seams/prompt-compiler-seam/mock.ts | src/lib/seams/prompt-compiler-seam/test.ts | N/A (dependency-injected seam) | hbpheonix | N/A | used by legacy `generation-workflow.ts` and seam tests |
| SafetyPolicySeam | src/lib/seams/safety-policy-seam/contract.ts | src/lib/seams/safety-policy-seam/probe.ts | N/A (fixture module: src/lib/seams/safety-policy-seam/fixtures.ts) | src/lib/seams/safety-policy-seam/mock.ts | src/lib/seams/safety-policy-seam/test.ts | N/A (dependency-injected seam) | hbpheonix | N/A | used by legacy workflow path and guard-rule tests |
| GalleryStoreSeam | src/lib/seams/gallery-store-seam/contract.ts | src/lib/seams/gallery-store-seam/probe.ts | N/A (fixture module: src/lib/seams/gallery-store-seam/fixtures.ts) | src/lib/seams/gallery-store-seam/mock.ts | src/lib/seams/gallery-store-seam/test.ts | N/A (dependency-injected seam) | hbpheonix | N/A | gallery persistence seam for legacy workflow path |
| TelemetrySeam | src/lib/seams/telemetry-seam/contract.ts | src/lib/seams/telemetry-seam/probe.ts | N/A (fixture module: src/lib/seams/telemetry-seam/fixtures.ts) | src/lib/seams/telemetry-seam/mock.ts | src/lib/seams/telemetry-seam/test.ts | N/A (dependency-injected seam) | hbpheonix | N/A | telemetry emission seam for legacy workflow path |
