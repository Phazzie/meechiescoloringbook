...
## Unreleased
- Every one of the eight modes is on the home page now. It used to show three, picked by the calendar, and link only those three — so on any given day five of them had no link anywhere in the app and no way to be found. On the day this was changed the three on offer were the same three already in the menu bar at the top of every page, so the strip was offering nothing new at all.
