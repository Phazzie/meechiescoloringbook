...
- One picture is one sheet. The glitter overlay stays on screen, where it belongs, instead of laying a grey wash over the lines you are about to draw on.
- Printing from a screen with no coloring page on it now says so on the paper — "make one first" — instead of the app, or a blank sheet.
