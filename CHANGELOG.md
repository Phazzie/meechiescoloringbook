...
- A reopened page never claims her approval — including one saved from the toolkit, and one saved before the studio recorded any of this. The words, the quote and her note all come back exactly as before; the one thing withheld is a ruling on the page that cannot be shown to be hers.
