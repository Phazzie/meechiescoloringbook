...
Meechie's Coloring Book is an adult relationship-verdict and statement line-art studio. People bring a situation, an excuse, or a receipt; Meechie names what happened, puts the consequence on record, and turns the result into something printable. The interface should feel theatrical, specific, and culturally grounded rather than therapeutic or child-oriented.

The target audience is adults who want sharp, funny relationship commentary with a high-glam visual treatment. The emotional tone is witty, direct, dramatic, and in control.
...
- **Headlines:** Fraunces italic at bold weights for a dramatic, editorial feel.
...
All interactive elements use rounded corners: `{rounded.md}` (8px) on inputs, `{rounded.lg}` (12px) on buttons and cards. Consistency across shapes keeps the high-glam interface cohesive without softening its tone.
...
- **Do** maintain generous spacing and breathing room—the interface should feel deliberate, not dense.
