...
import { z } from 'zod';
import { MeechieToolInputSchema, MeechieToolResultSchema } from './validators';
...
export const getMeechieToolFixture = (scenario: 'sample' | 'fault' = 'sample') =>
	scenario === 'fault' ? meechieToolFaultFixture : meechieToolSampleFixture;
