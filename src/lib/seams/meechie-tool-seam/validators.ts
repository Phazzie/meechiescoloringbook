// Purpose: Zod schemas for MeechieToolSeam.
...
export const validateMeechieToolInput = (input: unknown) => MeechieToolInputSchema.parse(input);
export const validateMeechieToolResult = (result: unknown) => MeechieToolResultSchema.parse(result);
