...
describe('GalleryStoreSeam mock contract', () => {
  ...
  it('listRecent respects the limit and returns the most recent records in order', async () => {
    const seam = createMockGalleryStoreSeam();
    ...
    // unshift() means last-saved is first; r3 was saved last so it is most recent
