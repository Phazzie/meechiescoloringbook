...
import { wigTryOnHttpErrorFixture, wigTryOnConfigErrorFixture } from './fixtures';
...
export const createMockWigTryOnSeam = (
  ...
  tryOn: async (request: WigTryOnRequest): Promise<Result<WigTryOnResult, typeof wigTryOnHttpErrorFixture | typeof wigTryOnConfigErrorFixture>> => {
