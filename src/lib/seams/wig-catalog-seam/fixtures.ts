...
export const sampleWigFixture: Wig = {
	...
	affiliateUrl:
		'https://www.beautyforever.com/straight-lace-front-wigs.html?utm_source=meechie',
...
export const sampleWigCatalogFixture: Wig[] = [
	sampleWigFixture,
	{
		...
		affiliateProgram: 'beautyforever',
		affiliateUrl:
			'https://www.beautyforever.com/body-wave-lace-front-wigs.html?utm_source=meechie',
