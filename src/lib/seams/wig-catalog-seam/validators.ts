...
export const affiliateProgramSchema = z.enum([
	'beautyforever',
	'wigsbuy',
	'luvmehair'
]);
export const hairTypeSchema = z.enum(['human', 'synthetic', 'blend']);
export const wigLengthSchema = z.enum([
	'short',
	'medium',
	'long',
	'extra-long'
...
export const validateWigCatalog = (input: unknown) =>
	wigCatalogSchema.parse(input);
