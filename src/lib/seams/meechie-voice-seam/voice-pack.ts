...
// Why: Prevent divergence across mock, legacy, and self-contained adapters.
// Info flow: voice-pack definition -> voice adapter / legacy voice adapter.
		...
		quotes: [
			{
				...
				notes: 'Canonical Meechie quote 1',
			...
			},
			{
				...
				defaultMode: true,
				coloringPageReady: true,
				notes: 'Canonical Meechie quote 2',
				visualMotifs: ['glam', 'boundaries']
			},
			{
				...
				defaultMode: true,
				coloringPageReady: true,
				notes: 'Canonical Meechie quote 3',
				visualMotifs: ['glam', 'boundaries']
			},
			{
				...
				defaultMode: true,
				coloringPageReady: true,
				notes: 'Canonical Meechie quote 4',
				visualMotifs: ['glam', 'boundaries']
			},
			{
				...
				defaultMode: true,
				coloringPageReady: true,
				notes: 'Canonical Meechie quote 5',
				visualMotifs: ['glam', 'boundaries']
			},
			{
				text: "Don't open the door. Not even a little bit. Cause if you open the door even a little bit, I'm comin through.",
				category: 'raw_anchor',
				rawness: 'raw',
				thirdPersonUsage: 'none',
				modeFit: ['random_meechie'],
				defaultMode: true,
				coloringPageReady: true,
				notes: 'Canonical Meechie quote 6',
				visualMotifs: ['glam', 'boundaries']
			},
			{
				text: "The biggest nigga in the house... the one y'all scared of? He's running from me.",
				category: 'raw_anchor',
				rawness: 'raw',
				thirdPersonUsage: 'none',
				modeFit: ['random_meechie'],
				defaultMode: true,
				coloringPageReady: true,
				notes: 'Canonical Meechie quote 7',
				visualMotifs: ['glam', 'boundaries']
			}
		]
	}
