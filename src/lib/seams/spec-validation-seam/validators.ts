// Purpose: Zod schemas for SpecValidationSeam.
...
export const validateColoringPageSpec = (spec: unknown) => ColoringPageSpecSchema.parse(spec);
export const validateSpecValidationInput = (input: unknown) => SpecValidationInputSchema.parse(input);
export const validateSpecValidationOutput = (output: unknown) => SpecValidationOutputSchema.parse(output);
