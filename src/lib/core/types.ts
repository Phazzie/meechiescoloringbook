// Purpose: Define core workflow types and dependency contracts.
// Why: Share type shapes across workflow, seams, and tests.
// Info flow: types -> workflow implementations/tests.
