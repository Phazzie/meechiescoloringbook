...
// Every page title the preview placeholder has ever shipped with, newest first.
// A draft whose title is any of these was never generated by the user — it is an
// untouched placeholder from whichever version they last opened.
//
// This exists because the "has the user generated anything?" check cannot compare
// against the CURRENT placeholder alone: the moment the placeholder changes, every
// older draft starts looking like real generated content, and the studio restores
// retired wording as though the user had produced it. Add the outgoing title here
// whenever DEFAULT_STUDIO_TEXT_OUTPUT.pageTitle changes. Never remove one.
export const PLACEHOLDER_PAGE_TITLES: readonly string[] = [
	'NOT EVEN A LITTLE BIT',
	"I DON'T ACT",
	'IN THIS ECONOMY'
];

export const isPlaceholderPageTitle = (title: string): boolean =>
	PLACEHOLDER_PAGE_TITLES.includes(title);
