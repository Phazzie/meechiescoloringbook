// Purpose: Implement WigTryOnSeam with live Gemini multi-image API calls.
// Why: Isolate Gemini API I/O behind the seam contract so tests can swap in a mock.
// Info flow: validated selfie + wig base64 -> Gemini generateContent -> portrait base64 Result.
import type {
	WigTryOnRequest,
	WigTryOnResult,
	WigTryOnSeam
