...
const meechieVoicePack: MeechieVoicePack = {
	...
	tone: {
		...
		dos: [
			'He brought me to his mama\'s house. He was scared of me.',
			'His brother got my number before he did.',
			'I went to her job. Just to sit.',
			'She fought me over him. I let her win. Took his car the next week.',
			'He said he was at work. His mama said different.',
			'I been knew. I just wasn\'t done with him yet.'
		],
		donts: [
			'The third one eats the best.',
			'My type is whoever\'s wife answers the phone first.',
			'He\'s not sorry — he\'s sorry you found out.',
			'It won\'t happen again. Translation: he\'ll get better at hiding it.',
			'Boundaries are beautiful.',
			'Stay unbothered, bestie.'
		],
		samples: [
