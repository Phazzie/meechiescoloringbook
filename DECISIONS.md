...
- Revisit criteria: Add the digest comparison when `proof-tape.mjs` records one. Revisit the deliberate omission of "require evidence for seam-changing diffs" if the repository decides CI should classify diffs by path.
