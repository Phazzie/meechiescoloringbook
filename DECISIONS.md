...
- Plan:
  ...
  - Files: `scripts/cipher-gate.mjs`, `scripts/proof-tape.mjs`, `tests/unit/evidence-gate-selection.test.ts`, `DECISIONS.md`, and the regenerated `docs/evidence/2026-09-03/` artifacts including `evidence-gate-selection-red-proof.txt`.
