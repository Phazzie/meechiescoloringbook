...
| `GEMINI_API_KEY` | Yes (for wig try-on) | — | Your Gemini API key for the wig try-on feature |
| `GEMINI_BASE_URL` | No | `https://generativelanguage.googleapis.com` | Gemini API base URL (currently unused — the wig try-on adapter hardcodes this endpoint) |
